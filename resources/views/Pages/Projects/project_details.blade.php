...
@section('page_subtitle')
    ...
    THINGS ASSOCIATED WITH PROJECT
            ...
            <div class="box-header with-border">
                ...
                <div class="box-body ">
                    ...
                    <div class="col-xs-3 table-responsive">
                        ...
                        <input type="text" class="form-control " placeholder="Enter Thing Name" name="thing_name">
                        <br>

                        <input type="submit" class="btn btn-block btn-success .btn-sm "  value="Create Thing"></input>
                        {!! Form::close() !!}
